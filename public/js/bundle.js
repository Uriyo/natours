...
// const stripe=Stripe("pk_test_51NPh6jSH1xsBqKj0iPEUhndMVWvgStK7ZIl4jkkCB1wMRASAjwJNvgxAFd62CcT0xyRoRTdvO44Gmq7Yhyouqlix00LxoTRLsZ");
//    export const bookTour= async tourId=>{
//       console.log(tourId);
//       try{
//        //1 get the checkout session from endpoint
//            const session=await axios(`http://127.0.0.1:300/api/v1/booking/checkout-session/${tourId}`);
//            console.log(session);
